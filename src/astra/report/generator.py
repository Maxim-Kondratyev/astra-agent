...
<footer>
    ...
    <div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:12px;padding:1rem 1.5rem;margin-bottom:1.5rem;color:#1e40af;font-size:0.82rem;">💬 <strong>Have questions about these findings?</strong> Chat with ASTRA in your terminal for remediation guidance, CLI commands, and IaC snippets:<br/><code style="background:#dbeafe;padding:2px 8px;border-radius:4px;margin-top:0.3rem;display:inline-block;">astra --chat</code></div>
    ...
    <p style="margin-top:1rem;font-size:0.68rem;color:#94a3b8;max-width:600px;margin-left:auto;margin-right:auto;">⚠️ AI-generated analysis may contain errors. Recommendations should be reviewed by qualified professionals before implementation. Use at your own risk.</p>
</footer>
</div>
</body>
</html>"""
